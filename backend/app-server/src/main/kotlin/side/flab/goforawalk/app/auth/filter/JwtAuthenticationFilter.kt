...
class JwtAuthenticationFilter(
  ...
  private fun validateAccessToken(request: HttpServletRequest): UserId {
    ...
    try {
      ...
      when (e) {
        is ExpiredJwtException -> throw AccessTokenExpiredException(e.message ?: "Access token expired")
        else -> throw JwtAuthenticationException.invalidToken(e.message ?: "Invalid JWT token")
      }
    }
  }
