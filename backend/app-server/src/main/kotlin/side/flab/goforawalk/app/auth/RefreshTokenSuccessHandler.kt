...
@Component
class RefreshTokenSuccessHandler(
  ...
  override fun onAuthenticationSuccess(
    ...
    // 새로운 토큰 생성 (generate 메서드가 자동으로 DB에 저장)
    val appToken = tokenProvider.generate(userDetails)
  ...
  private fun writeResponse(
    ...
    response.writer.use { writer ->
      writer.write(objectMapper.writeValueAsString(refreshResponse))
      writer.flush()
    }
  }
}